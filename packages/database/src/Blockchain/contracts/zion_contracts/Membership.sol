...
contract Membership is ERC1155Struct, Ownable, zPausable {
    /////////////////////
    /// Minting constants
    /////////////////////
        ...
        onlyOneNFTperAddress(account)
    {
        require(
            account != address(0),
            "ZION.MEMBERSHIO.NFT::mint:: invalid recipient"
        );
    ...
    function _beforeTokenTransfer(
        ...
        super._beforeTokenTransfer(
            ZionLib.createTokenTransfer(operator, to, from, ids, amounts, data)
        );
    }
