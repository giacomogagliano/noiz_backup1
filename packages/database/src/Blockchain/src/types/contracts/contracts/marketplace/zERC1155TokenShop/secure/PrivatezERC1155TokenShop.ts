...
export interface PrivatezERC1155TokenShopInterface extends utils.Interface {
  functions: {
    "tokensBoughtByBuyer(address,uint256)": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "tokensBoughtByBuyer"): FunctionFragment;
...
export interface PrivatezERC1155TokenShop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrivatezERC1155TokenShopInterface;
