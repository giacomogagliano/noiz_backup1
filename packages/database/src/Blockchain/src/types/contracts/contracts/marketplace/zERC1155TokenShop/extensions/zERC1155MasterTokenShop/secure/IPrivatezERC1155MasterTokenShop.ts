...
export interface IPrivatezERC1155MasterTokenShopInterface
  ...
  getEvent(
    nameOrSignatureOrTopic: "Dividend"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "SnapshotTokenSet"
  ): EventFragment;
}
...
export type DividendEventFilter =
  TypedEventFilter<DividendEvent>;
...
export interface IPrivatezERC1155MasterTokenShop
  ...
  interface: IPrivatezERC1155MasterTokenShopInterface;
