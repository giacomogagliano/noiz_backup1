...
export interface ERC1155MasterTokenShopInterface extends utils.Interface {
  functions: {
...
export interface ERC1155MasterTokenShop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155MasterTokenShopInterface;
