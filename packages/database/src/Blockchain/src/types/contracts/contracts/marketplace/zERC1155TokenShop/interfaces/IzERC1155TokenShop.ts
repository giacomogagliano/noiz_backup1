...
export interface IzERC1155TokenShopInterface extends utils.Interface {
  functions: {
...
export interface IzERC1155TokenShop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IzERC1155TokenShopInterface;
