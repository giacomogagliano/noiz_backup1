...
export interface ZERC1155MasterTokenShopInterface extends utils.Interface {
  functions: {
    "buyTokens(bytes)": FunctionFragment;
    "capitalOfAt(address,uint256)": FunctionFragment;
    "dividend()": FunctionFragment;
    "dividendOnSharesTransfer()": FunctionFragment;
    ...
    "ierc1155master()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "dividendOnSharesTransfer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ierc1155master",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ZERC1155MasterTokenShop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZERC1155MasterTokenShopInterface;
  ...
  functions: {
    ...
    ierc1155master(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    dividendOnSharesTransfer(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    ierc1155master(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ierc1155master(overrides?: CallOverrides): Promise<PopulatedTransaction>;
