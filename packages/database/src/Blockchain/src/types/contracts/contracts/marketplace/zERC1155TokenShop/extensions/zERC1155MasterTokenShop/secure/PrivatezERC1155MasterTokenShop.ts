...
export interface PrivatezERC1155MasterTokenShopInterface
...
export interface PrivatezERC1155MasterTokenShop extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrivatezERC1155MasterTokenShopInterface;
