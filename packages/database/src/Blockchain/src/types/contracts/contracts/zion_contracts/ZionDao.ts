...
export interface ZionDaoInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "ZionDaoCreated(address,string,uint256,uint256,uint256,address,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "ZionDaoCreated"): EventFragment;
}
...
export interface ZionDaoCreatedEventObject {
  deployer: string;
  name: string;
...
export type ZionDaoCreatedEvent = TypedEvent<
  [string, string, BigNumber, BigNumber, BigNumber, string, BigNumber],
  ZionDaoCreatedEventObject
>;

export type ZionDaoCreatedEventFilter = TypedEventFilter<ZionDaoCreatedEvent>;

export interface ZionDao extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZionDaoInterface;
  ...
  filters: {
    ...
    "ZionDaoCreated(address,string,uint256,uint256,uint256,address,uint256)"(
      deployer?: null,
      name?: null,
      votingDelay?: null,
      votingPeriod?: null,
