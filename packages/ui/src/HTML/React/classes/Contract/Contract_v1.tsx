...
export type Contract_v1Booleans = { small?: boolean };

export type Contract_v1Props = NoizProps<
  Contract_v1Data & Contract_v1Booleans
>;

export type Contract_v1ClassBooleans = {};

export type Contract_v1ClassProps = Flatten<
  NoizDatas<Contract_v1Props> & Contract_v1ClassBooleans
>;

export type Contract_v1AsChild = MakeAsChild<
  "Contract",
  Contract_v1ClassProps
>;
/////////////
export interface IContract_v1 {}
////////CLASS
export class Contract_v1 extends BaseNoiz<
  Contract_v1Data & Contract_v1Booleans,
  Contract_v1ClassBooleans
> {
  constructor(props: Contract_v1ClassProps) {
    super(props);
  }

  Html = (props: Contract_v1Props) => {
  ...
  Mapper = Contract_v1.mapperFactory(this.Style);
