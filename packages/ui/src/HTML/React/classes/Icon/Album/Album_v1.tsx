...
export type Album_v1Booleans = "Album_v1Booleans";
export type Album_v1Props = "Album_v1Props";
export type Album_v1ClassProps = "Album_v1ClassProps";
export type Album_v1AsChild = "Album_v1AsChild";

export const Album_v2 = (
  <>
    <g clipPath="url(#clip0_1458_1862)">
...
const album_ = new IconPath();
album_.name = Icons.album;
album_.JsxPath = Album_v2;
album_.filled = true;
