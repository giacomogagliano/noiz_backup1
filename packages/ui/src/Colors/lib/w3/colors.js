...
(function () {
  ...
  function toColorObject(c) {
    ...
    if (
      ...
      for (i = 0; i < colornames.length; i++) {
        if (
          c.toLowerCase() == colornames[i].toLowerCase()
        ) {
          colorhexs = getColorArr("hexs");
          match = true;
          rgb = {
  ...
  function roundDecimals(c) {
    ...
    c.ncol =
      c.ncol.substr(0, 1) +
      Math.round(Number(c.ncol.substr(1)));
  ...
  function ncsToRgb(ncs) {
    ...
    if (bc !== "N") {
      ...
      if (bc === "Y" && percent <= 60) {
        ...
        red1 =
          (Math.sqrt(14884 - Math.pow(factor1, 2)) - 22) /
          100;
      } else if (
        (bc === "R" && percent > 80) ||
        bc === "B"
        ...
        factor1 = percent - 170;
        red1 =
          (Math.sqrt(33800 - Math.pow(factor1, 2)) - 70) /
          100;
      }
      if (bc === "Y" && percent <= 80) {
        blue1 = 0;
        ...
        blue1 =
          (104 - Math.sqrt(11236 - Math.pow(factor1, 2))) /
          100;
      } else if (
        (bc === "R" && percent > 60) ||
        (bc === "B" && percent <= 80)
        ...
        blue1 =
          (Math.sqrt(10000 - Math.pow(factor1, 2)) - 10) /
          100;
      } else if (
        (bc === "B" && percent > 80) ||
        (bc === "G" && percent <= 40)
        ...
        blue1 =
          (122 - Math.sqrt(19881 - Math.pow(factor1, 2))) /
          100;
      ...
      if (bc === "Y") {
        ...
        green1 =
          (67.5 - Math.sqrt(5776 - Math.pow(factor1, 2))) /
          100;
      } else if (bc === "B" && percent <= 60) {
        factor1 = 1 * percent - 68.5;
        green1 =
          (6.5 +
            Math.sqrt(7044.5 - Math.pow(factor1, 2))) /
          100;
      } else if (
        (bc === "B" && percent > 60) ||
        (bc === "G" && percent <= 60)
      ...
      red2 =
        ((factor1 - red1) * (100 - chroma1)) / 100 + red1;
      green2 =
        ((factor1 - green1) * (100 - chroma1)) / 100 +
        green1;
      blue2 =
        ((factor1 - blue1) * (100 - chroma1)) / 100 +
        blue1;
      ...
      factor2 = 1 / max;
      r = parseInt(
        ((red2 * factor2 * (100 - black1)) / 100) * 255,
        10
      );
      g = parseInt(
        ((green2 * factor2 * (100 - black1)) / 100) * 255,
        10
      );
      b = parseInt(
        ((blue2 * factor2 * (100 - black1)) / 100) * 255,
        10
      );
      if (r > 255) {
        r = 255;
